...
noTripeticiones:- equipo(E1), equipo(E2), equipo(E3), equipo(E4),
    E1 \= E2, E1 \= E3, E1 \= E4,   % puede que pete con jornada en vez de primeraJornada()
    E2 \= E3, E2 \= E4,
    E3 \= E4,       % con menos jornadas puede que pete!!!!!!
    jornada(J1), tresJornadas(J1,J2,J3),    %¿¿¿jornada() o primeraJornada()???
    writeClause([-p(E1,E2,J1),-p(E1,E3,J2),-p(E1,E4,J3)]),
...
%NEW
displaySol(M):-  jornada(J),nl, member(p(E1,E2,J), M ),nl,write(p(E1,E2,J)), write(' '), fail.
displaySol(_):- nl,nl.
