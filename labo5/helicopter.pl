...
heli( [], AccumulatedDistance, [CurrentPoint|RouteSoFar], [] ):- %...
    ...
    distanceBetweenTwoPoints( CurrentPoint, BasePoint, D ),
    AccumulatedDistance1 is AccumulatedDistance+D,
    storeRouteIfBetter( AccumulatedDistance1, [BasePoint, CurrentPoint | RouteSoFar ] ), fail.
